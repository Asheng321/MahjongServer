 ...
 * @Description 消息协议解码
 */
public class ClientMessageProtocolDecoder extends ProtocolDecoderAdapter {

  private Logger log=Logger.getLogger(ClientMessageProtocolDecoder.class);

  @SuppressWarnings("unused")
  private Charset charset;

  public ClientMessageProtocolDecoder(Charset charest) {
